/// Gömülü font — FreeMono9pt7b (Adafruit GFX)
///
/// tools/font2rust.py ile C header'dan dönüştürüldü.
/// Kaynak: Adafruit-GFX-Library/Fonts/FreeMono9pt7b.h
/// Lisans: GNU FreeFont (GPL + font exception)

use crate::font::GfxGlyph;

pub const FIRST: u16 = 0x20;
pub const LAST: u16 = 0x7E;
pub const Y_ADVANCE: u8 = 18;

pub static BITMAP: [u8; 844] = [
...
pub static GLYPHS: [GfxGlyph; 95] = [
    GfxGlyph::new(  0, 0,  0, 11,  0,   1), // 0x20 ' '
    GfxGlyph::new(  0, 2, 11, 11,  4, -10), // 0x21 '!'
    GfxGlyph::new(  3, 6,  5, 11,  2, -10), // 0x22 '"'
    GfxGlyph::new(  7, 7, 12, 11,  2, -10), // 0x23 '#'
    GfxGlyph::new( 18, 8, 12, 11,  1, -10), // 0x24 '$'
    GfxGlyph::new( 30, 7, 11, 11,  2, -10), // 0x25 '%'
    GfxGlyph::new( 40, 7, 10, 11,  2,  -9), // 0x26 '&'
    GfxGlyph::new( 49, 3,  5, 11,  4, -10), // 0x27 '''
    GfxGlyph::new( 51, 2, 13, 11,  5, -10), // 0x28 '('
    GfxGlyph::new( 55, 2, 13, 11,  4, -10), // 0x29 ')'
    GfxGlyph::new( 59, 7,  7, 11,  2, -10), // 0x2A '*'
    GfxGlyph::new( 66, 7,  7, 11,  2,  -8), // 0x2B '+'
    GfxGlyph::new( 73, 3,  5, 11,  2,  -1), // 0x2C ','
    GfxGlyph::new( 75, 9,  1, 11,  1,  -5), // 0x2D '-'
    GfxGlyph::new( 77, 2,  2, 11,  4,  -1), // 0x2E '.'
    GfxGlyph::new( 78, 7, 13, 11,  2, -11), // 0x2F '/'
    GfxGlyph::new( 90, 7, 11, 11,  2, -10), // 0x30 '0'
    GfxGlyph::new(100, 5, 11, 11,  3, -10), // 0x31 '1'
    GfxGlyph::new(107, 7, 11, 11,  2, -10), // 0x32 '2'
    GfxGlyph::new(117, 8, 11, 11,  1, -10), // 0x33 '3'
    GfxGlyph::new(128, 6, 11, 11,  3, -10), // 0x34 '4'
    GfxGlyph::new(137, 7, 11, 11,  2, -10), // 0x35 '5'
    GfxGlyph::new(147, 7, 11, 11,  2, -10), // 0x36 '6'
    GfxGlyph::new(157, 7, 11, 11,  2, -10), // 0x37 '7'
    GfxGlyph::new(167, 7, 11, 11,  2, -10), // 0x38 '8'
    GfxGlyph::new(177, 7, 11, 11,  2, -10), // 0x39 '9'
    GfxGlyph::new(187, 2,  8, 11,  4,  -7), // 0x3A ':'
    GfxGlyph::new(189, 3, 11, 11,  3,  -7), // 0x3B ';'
    GfxGlyph::new(194, 8,  8, 11,  1,  -8), // 0x3C '<'
    GfxGlyph::new(202, 9,  4, 11,  1,  -6), // 0x3D '='
    GfxGlyph::new(207, 9,  8, 11,  1,  -8), // 0x3E '>'
    GfxGlyph::new(216, 7, 10, 11,  2,  -9), // 0x3F '?'
    GfxGlyph::new(225, 8, 12, 11,  2, -10), // 0x40 '@'
    GfxGlyph::new(237,11, 10, 11,  0,  -9), // 0x41 'A'
    GfxGlyph::new(251, 9, 10, 11,  1,  -9), // 0x42 'B'
    GfxGlyph::new(263, 9, 10, 11,  1,  -9), // 0x43 'C'
    GfxGlyph::new(275, 9, 10, 11,  1,  -9), // 0x44 'D'
    GfxGlyph::new(287, 9, 10, 11,  1,  -9), // 0x45 'E'
    GfxGlyph::new(299, 9, 10, 11,  1,  -9), // 0x46 'F'
    GfxGlyph::new(311,10, 10, 11,  1,  -9), // 0x47 'G'
    GfxGlyph::new(324, 9, 10, 11,  1,  -9), // 0x48 'H'
    GfxGlyph::new(336, 5, 10, 11,  3,  -9), // 0x49 'I'
    GfxGlyph::new(343, 8, 10, 11,  2,  -9), // 0x4A 'J'
    GfxGlyph::new(353, 9, 10, 11,  1,  -9), // 0x4B 'K'
    GfxGlyph::new(365, 8, 10, 11,  2,  -9), // 0x4C 'L'
    GfxGlyph::new(375,11, 10, 11,  0,  -9), // 0x4D 'M'
    GfxGlyph::new(389, 9, 10, 11,  1,  -9), // 0x4E 'N'
    GfxGlyph::new(401, 9, 10, 11,  1,  -9), // 0x4F 'O'
    GfxGlyph::new(413, 8, 10, 11,  1,  -9), // 0x50 'P'
    GfxGlyph::new(423, 9, 13, 11,  1,  -9), // 0x51 'Q'
    GfxGlyph::new(438, 9, 10, 11,  1,  -9), // 0x52 'R'
    GfxGlyph::new(450, 7, 10, 11,  2,  -9), // 0x53 'S'
    GfxGlyph::new(459, 9, 10, 11,  1,  -9), // 0x54 'T'
    GfxGlyph::new(471, 9, 10, 11,  1,  -9), // 0x55 'U'
    GfxGlyph::new(483,11, 10, 11,  0,  -9), // 0x56 'V'
    GfxGlyph::new(497,11, 10, 11,  0,  -9), // 0x57 'W'
    GfxGlyph::new(511, 9, 10, 11,  1,  -9), // 0x58 'X'
    GfxGlyph::new(523, 9, 10, 11,  1,  -9), // 0x59 'Y'
    GfxGlyph::new(535, 7, 10, 11,  2,  -9), // 0x5A 'Z'
    GfxGlyph::new(544, 2, 13, 11,  5, -10), // 0x5B '['
    GfxGlyph::new(548, 7, 13, 11,  2, -11), // 0x5C '\'
    GfxGlyph::new(560, 2, 13, 11,  4, -10), // 0x5D ']'
    GfxGlyph::new(564, 7,  5, 11,  2, -10), // 0x5E '^'
    GfxGlyph::new(569,11,  1, 11,  0,   2), // 0x5F '_'
    GfxGlyph::new(571, 3,  3, 11,  3, -11), // 0x60 '`'
    GfxGlyph::new(573, 9,  8, 11,  1,  -7), // 0x61 'a'
    GfxGlyph::new(582, 9, 11, 11,  1, -10), // 0x62 'b'
    GfxGlyph::new(595, 7,  8, 11,  2,  -7), // 0x63 'c'
    GfxGlyph::new(602, 9, 11, 11,  1, -10), // 0x64 'd'
    GfxGlyph::new(615, 8,  8, 11,  1,  -7), // 0x65 'e'
    GfxGlyph::new(623, 6, 11, 11,  3, -10), // 0x66 'f'
    GfxGlyph::new(632, 9, 11, 11,  1,  -7), // 0x67 'g'
    GfxGlyph::new(645, 9, 11, 11,  1, -10), // 0x68 'h'
    GfxGlyph::new(658, 7, 10, 11,  2,  -9), // 0x69 'i'
    GfxGlyph::new(667, 5, 13, 11,  3,  -9), // 0x6A 'j'
    GfxGlyph::new(676, 8, 11, 11,  2, -10), // 0x6B 'k'
    GfxGlyph::new(687, 7, 11, 11,  2, -10), // 0x6C 'l'
    GfxGlyph::new(697, 9,  8, 11,  1,  -7), // 0x6D 'm'
    GfxGlyph::new(706, 9,  8, 11,  1,  -7), // 0x6E 'n'
    GfxGlyph::new(715, 9,  8, 11,  1,  -7), // 0x6F 'o'
    GfxGlyph::new(724, 9, 11, 11,  1,  -7), // 0x70 'p'
    GfxGlyph::new(737, 9, 11, 11,  1,  -7), // 0x71 'q'
    GfxGlyph::new(750, 7,  8, 11,  3,  -7), // 0x72 'r'
    GfxGlyph::new(757, 7,  8, 11,  2,  -7), // 0x73 's'
    GfxGlyph::new(764, 8, 10, 11,  2,  -9), // 0x74 't'
    GfxGlyph::new(774, 8,  8, 11,  1,  -7), // 0x75 'u'
    GfxGlyph::new(782, 9,  8, 11,  1,  -7), // 0x76 'v'
    GfxGlyph::new(791, 9,  8, 11,  1,  -7), // 0x77 'w'
    GfxGlyph::new(800, 9,  8, 11,  1,  -7), // 0x78 'x'
    GfxGlyph::new(809, 9, 11, 11,  1,  -7), // 0x79 'y'
    GfxGlyph::new(822, 7,  8, 11,  2,  -7), // 0x7A 'z'
    GfxGlyph::new(829, 3, 13, 11,  4, -10), // 0x7B '{'
    GfxGlyph::new(834, 1, 13, 11,  5, -10), // 0x7C '|'
    GfxGlyph::new(836, 3, 13, 11,  4, -10), // 0x7D '}'
    GfxGlyph::new(841, 7,  3, 11,  2,  -6), // 0x7E '~'
];
