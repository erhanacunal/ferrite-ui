...
#[inline(always)]
unsafe fn sclk_high() {
    core::ptr::write_volatile(GPIO_OUT_W1TS, SCLK_BIT);
}
#[inline(always)]
unsafe fn sclk_low() {
    core::ptr::write_volatile(GPIO_OUT_W1TC, SCLK_BIT);
}

#[inline(always)]
unsafe fn mosi_high() {
    core::ptr::write_volatile(GPIO_OUT_W1TS, MOSI_BIT);
}
#[inline(always)]
unsafe fn mosi_low() {
    core::ptr::write_volatile(GPIO_OUT_W1TC, MOSI_BIT);
}

#[inline(always)]
unsafe fn cs_high() {
    core::ptr::write_volatile(GPIO_OUT1_W1TS, CS_BIT1);
}
#[inline(always)]
unsafe fn cs_low() {
    core::ptr::write_volatile(GPIO_OUT1_W1TC, CS_BIT1);
}
